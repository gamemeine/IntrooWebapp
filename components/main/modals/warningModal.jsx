...
export const WarningModal = ({ text, icon, onSubmit, onCancel, onClose }) => {
  return (
    <div className="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 md:inset-0 h-modal md:h-full flex justify-center items-center bg-neutral-800/25">
